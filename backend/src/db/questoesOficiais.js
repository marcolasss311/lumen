// Questões oficiais de vestibulares usadas para popular um banco vazio.
module.exports = [
  {
    materia: "Matemática",
    topico: "Porcentagem",
  ...
  },
  {
    ...
    alternativas: [
      ...
      {
        letra: "C",
        texto: "Alinhamento imediato e incondicional ao Eixo na Segunda Guerra.",
        correta: false,
      },
  ...
  },
  {
    ...
    alternativas: [
      ...
      {
        letra: "D",
        texto: "Separar orações coordenadas aditivas com o mesmo sujeito.",
        correta: false,
      },
