      ...
      <main className="w-full max-w-3xl flex flex-col items-center text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        <div className="space-y-4">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Bem-vindo à sua plataforma de estudos. Utilize nossa Inteligência
            Artificial para gerar baterias de questões exclusivas e analisar
            suas respostas com precisão cirúrgica.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full pt-8">
          ...
          >
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Gere listas de questões personalizadas para seu nível de ensino,
              matéria e curso.
            </p>
          </button>
          ...
          <Link
            href="/desempenho"
            className="group flex flex-col items-center p-8 bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-800 transition-all cursor-pointer"
          >
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Analise seu histórico de notas e confira os feedbacks das suas
              correções passadas.
            </p>
          </Link>
        </div>
            ...
            <div className="flex justify-between items-center border-b dark:border-gray-700 pb-3">
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                  Qual é o seu nível de estudo?
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Adaptamos as questões e os filtros de acordo com sua fase
                </p>
              </div>
              <button
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Do 1º ao 9º Ano com linguagem e conceitos didáticos
                    adequados à idade.
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    1º ao 3º Ano do EM, preparação intensiva para ENEM, FUVEST e
                    vestibulares.
                  </p>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300">
                      Novo
                    </span>
                  </div>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Digite seu Curso (ex: Direito, Engenharia) e a Disciplina
