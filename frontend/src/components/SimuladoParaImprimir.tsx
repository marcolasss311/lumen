...
export const SimuladoParaImprimir = React.forwardRef<HTMLDivElement, Props>(
  ({ questoes, alunoNome, materia }, ref) => {
    return (
      <div
        ref={ref}
        className="p-10 bg-white text-black font-serif hidden print:block"
      >
        <div className="text-center border-b-2 border-black pb-4 mb-8">
          <h1 className="text-3xl font-bold uppercase mb-2">Simulado Lumen</h1>
          <p className="text-lg">
            Aluno(a):{" "}
            {alunoNome || "____________________________________________"}
          </p>
