        ...
        <div className="space-y-6">
          <div className="p-4 bg-gray-50 dark:bg-gray-900 border dark:border-gray-700 rounded-lg">
            ...
            <p className="text-gray-800 dark:text-gray-200">
              {respostaSelecionada || "Nenhuma resposta fornecida."}
            </p>
          </div>

          {feedback && (
            <div
              className={`p-5 border rounded-lg ${feedback.nota >= 50 ? "bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800/40" : "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800/40"}`}
            >
